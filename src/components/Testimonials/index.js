  ...
  return (
    <div className="container">
        ...
        <Card data-aos="zoom-in" className="myCard">
          <div className="flexRow align-center">
            ...
            <div className="mlr-10">
              <p className="primaryColor font-16">Annavi Raja</p>
      ...
      <Card className="m-auto contactCard">
        ...
        <p className="text-center font-25">annaviraja.arikrishnan@yahoo.com</p>
        <br />
        <p className="text-center font-25">+91-9791337337</p>
      </Card>
    </div>
  );
};
